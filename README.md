...
Config files: `config_franka.json` (sim, joystick), `config_franka_real.json` (real FR3), `config_tutorial_metaworld.json` (Tier 1), `config_tutorial_franka.json` (Tier 3).
